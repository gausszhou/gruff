...
func TestRender_CodeBlock(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input: "```\ncode\n```\n",
			check: []string{"\x1b[38;2;80;250;123m  code\x1b[39m", "```"},
		},
		{
			name:  "fenced code with language",
			input: "```go\nvar x = 1\n```\n",
			check: []string{"\x1b[38;2;92;156;245mgo\x1b[39m", "\x1b[38;2;80;250;123m  var x = 1\x1b[39m"},
		},
		{
			name:  "indented code block",
			input: "    indented\n",
			check: []string{"\x1b[38;2;80;250;123m  indented"},
		},
		{
			name:  "multi-line fenced code",
			input: "```\nline1\nline2\n```\n",
			check: []string{"\x1b[38;2;80;250;123m  line1", "\x1b[38;2;80;250;123m  line2"},
		},
	}
